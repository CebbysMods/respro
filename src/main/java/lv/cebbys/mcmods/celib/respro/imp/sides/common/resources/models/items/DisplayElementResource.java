package lv.cebbys.mcmods.celib.respro.imp.sides.common.resources.models.items;
...
public class DisplayElementResource extends JsonResource {
    @JsonPart(path = "rotation")
    private Integer[] rotation;
    @JsonPart(path = "translation")
